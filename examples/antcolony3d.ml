...
let jackMain array () =
  ...
  let channels = just_the_path_from_nodes nodes 4 in
  let channels2 = just_the_path_from_nodes nodes2 4 in
  let channels3 = just_the_path_from_nodes nodes3 4 in
  let channels4 = just_the_path_from_nodes nodes4 4 in
