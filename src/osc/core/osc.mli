...
module OscTypes : sig
  (** OscTypes representing OSC packets. *)
...
module Codec : sig
  ...
  val of_packet : OscTypes.packet -> string
...
module Transport : sig
  ...
  module type TRANSPORT = sig
    ...
    (** OscTypes and functions for handling clients for this type of transport. *)
    module Client : sig
    ...
    (** OscTypes and functions for handling servers for this type of transport. *)
    module Server : sig
  ...
  module Make : functor (T : TRANSPORT) -> sig
    ...
    (** OscTypes and functions for handling OSC clients. *)
    module Client : sig
      ...
      val send : t -> T.sockaddr -> OscTypes.packet -> unit T.Io.t
